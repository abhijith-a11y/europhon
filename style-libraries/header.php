  ...
  <header class="site-header">
    ...
    <!-- sub menu -->
                    ...
                    <ul class="nav_listing sub_menu_items_1">
                        ...
                        <li>
                            <span class="nav-link product-nav-item active" data-product="symfony-glass" data-image="<?php echo get_template_directory_uri(); ?>/images/sym-img-2.png" data-link="/products-symphony">Symfony® Glass</span>
                        </li>
                          <li>
                            <span class="nav-link product-nav-item" data-product="symfony-wall" data-image="<?php echo get_template_directory_uri(); ?>/images/sym-img-2.png" data-link="/products-symphony">Symfony® Wall</span>
                        </li>
                          <li>
                          ...
                          <li>
                            <span class="nav-link product-nav-item" data-product="symfony-ceiling" data-image="<?php echo get_template_directory_uri(); ?>/images/sym-img-2.png" data-link="/products-symphony">Symfony® Ceiling</span>
                        </li>
                          <li>
...
<!-- sub menu end -->
    ...
    <div class="product-image-container">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/images/sym-img-2.png" alt="Symfony Wall" class="product-image" data-product="symfony-wall">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/images/sym-img-2.png" alt="Symfony Ceiling" class="product-image" data-product="symfony-ceiling">
